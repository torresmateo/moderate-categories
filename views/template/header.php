...
if(isset($_GET['tab']) && in_array($_GET['tab'],array('1','2','3')))
    $tab = $_GET['tab']
...
<div class="wrap">
    <h2 style="border-bottom: 1px solid #CCC; padding-bottom: 0px; white-space: nowrap;">
        ...
        <a href="<?php echo get_bloginfo('url').'/wp-admin/admin.php?page=moderate-categories&tab=2'?>" class="nav-tab <?php if($tab == 2) echo "nav-tab-active";?>">Post Types</a>
        <a href="<?php echo get_bloginfo('url').'/wp-admin/admin.php?page=moderate-categories&tab=3'?>" class="nav-tab <?php if($tab == 3) echo "nav-tab-active";?>">README</a>
